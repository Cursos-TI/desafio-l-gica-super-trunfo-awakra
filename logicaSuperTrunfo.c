...
int main()
{
       ...
       int escolha_menu, escolha_menu2, cidade_carta1, pontos_turisticos_carta1, cidade_carta2, pontos_turisticos_carta2;
       ...
       if (escolha_menu == escolha_menu2)
       {
              printf("Voce repetiu o mesmo atributo para comparacao!\n");
       }
       else
       {
              printf("\n--------Comparando atributos---------------\n");
